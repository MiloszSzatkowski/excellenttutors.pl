    ...
    <header class="Kontakt container" style="height:100vh; padding-top:200px; text-align:center;">
      <div class="row">
          ...
          <div class="col-md-6 col-sm-10">
            <p class="d-block center gold_border" style="padding:20px;">Wystąpił krytyczny błąd wysyłania wiadomości. Prosimy o kontakt na adres mailowy
              <a href="mailto:biuro@excellenttutors.pl">biuro@excellenttutors.pl</a> lub o telefon/sms do biura: 510 900 693 / 511 349 113.</p>
