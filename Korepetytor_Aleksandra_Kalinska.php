        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div style="padding:3em;">
              <a href="#">
                <img src="images/Korepetytorzy/sylwetka.png" class="kor-border" alt="" style="width:100%; border-radius:5px;">
